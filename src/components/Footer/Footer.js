            ...
            {/* footer part 1st column */}
                <Col md={4}>
                    <div className="d-flex flex-column align-items-center p-3">
                        <div>
                            <h2 className="logo-text p-0 m-0 my-3">Shuvro Baset</h2>
                            ...
                            <div className="d-flex  align-items-center text-white">
                                ...
                                <p className="m-3"> +880-1673841675 <br />
                                                    +880-1521561350
                                </p>
                            </div>
                            <div className="d-flex justify-content-between align-items-center text-white">
                                <i className="icon-pr2 social-icon fab fa-google icon-font"></i>
                                <p className="m-3"> shuvro.aps.75@gmail.com <br />
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <Col md={4}>
                    <div className="text-white d-flex justify-content-center align-items-center p-3">
                        <div>
                            ...
                            <p><i className="icon-pr2 fas fa-chevron-right mx-2"></i>Blogs</p>
            ...
            {/* footer part 3rd column */}
                ...
                <Col md={4}>
                    <div className="text-white p-3 contact">
                        ...
                        <br />
                        <button className='btn tech-button'>Send</button>
                    </div>
                </Col>
            </Row>
