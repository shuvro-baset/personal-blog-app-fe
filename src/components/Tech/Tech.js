...
const Tech = () => {
    return (
        <Container>
            ...
            <Row className="my-5">
                <Col md={4} data-aos="zoom-in-right">
                ...
                <Col md={4}>
                    <div className="d-flex flex-column justify-content-center align-content-center">
                        <img data-aos="zoom-out-up" className="img-fluid my-2 rounded" src="https://images.unsplash.com/photo-1592609931095-54a2168ae893?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
                        <img data-aos="zoom-out-down" className="img-fluid my-2 rounded" src="https://images.unsplash.com/photo-1603468620905-8de7d86b781e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fGRldmVsb3BlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="" />
                    </div>
                </Col>
                <Col md={4} data-aos="zoom-in-left">
